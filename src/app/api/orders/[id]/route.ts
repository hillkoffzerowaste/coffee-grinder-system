...
export async function GET(_:Request,context:{params:Promise<{id:string}>}){
 ...
 try{
  const bags=await readRows(auth.profile.id,`select b.id,b.bag_no,b.queue_seq,b.status,b.product_name_snapshot,b.sku_snapshot,b.size_grams_snapshot,b.grind_value_snapshot,b.grinder_name_snapshot,b.blend_group_id,b.blend_group_no,b.process_mode,b.started_at,b.ground_at,b.completed_at,
