...
try{
 ...
 for(const name of ['001_neon','002_manual_grinds','003_thai_catalog','004_complete_after_grinding','005_scan_batch_grinding','006_admin_control_center','007_blend_groups','008_drop_legacy_start_scan_batch','009_grinding_requires_batch','010_order_notes','011_blend_group_mixed_grinds']){
  ...
  const required={'002_manual_grinds':'001_neon','003_thai_catalog':'002_manual_grinds','004_complete_after_grinding':'003_thai_catalog','005_scan_batch_grinding':'004_complete_after_grinding','006_admin_control_center':'005_scan_batch_grinding','007_blend_groups':'006_admin_control_center','008_drop_legacy_start_scan_batch':'007_blend_groups','009_grinding_requires_batch':'008_drop_legacy_start_scan_batch','010_order_notes':'009_grinding_requires_batch','011_blend_group_mixed_grinds':'010_order_notes'}[name];
